...
RcppExport SEXP _highfrequency_liLinton(SEXP modelSEXP, SEXP nObsSEXP, SEXP nSeriesSEXP, SEXP nDaysSEXP, SEXP dtSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type model(modelSEXP);
    Rcpp::traits::input_parameter< const int >::type nObs(nObsSEXP);
    Rcpp::traits::input_parameter< const int >::type nSeries(nSeriesSEXP);
    Rcpp::traits::input_parameter< const int >::type nDays(nDaysSEXP);
    Rcpp::traits::input_parameter< const arma::mat& >::type dt(dtSEXP);
    rcpp_result_gen = Rcpp::wrap(liLinton(model, nObs, nSeries, nDays, dt));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_highfrequency_liLinton", (DL_FUNC) &_highfrequency_liLinton, 5},
    {NULL, NULL, 0}
};
